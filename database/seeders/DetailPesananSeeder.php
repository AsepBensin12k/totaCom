...
class DetailPesananSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('detail_pesanans')->insert([
            ...
            ['id_pesanan' => 3,  'id_produk' => 4, 'qty' => 6, 'harga' => 900000,  'created_at' => $now, 'updated_at' => $now],
            ['id_pesanan' => 4,  'id_produk' => 6, 'qty' => 5, 'harga' => 200000,  'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_pesanan' => 13, 'id_produk' => 4, 'qty' => 8, 'harga' => 900000,  'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_pesanan' => 21, 'id_produk' => 1, 'qty' => 8, 'harga' => 7000000, 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_pesanan' => 24, 'id_produk' => 6, 'qty' => 8, 'harga' => 200000,  'created_at' => $now, 'updated_at' => $now],
