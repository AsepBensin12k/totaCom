        ...
        <form action="{{ route('profile.update') }}" method="POST" class="mt-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="id_provinsi" id="id_provinsi" class="w-full px-3 py-2 border border-gray-300 rounded-md">
                ...
                <div>
                    ...
                    <select name="id_kabupaten" id="id_kabupaten" class="w-full px-3 py-2 border border-gray-300 rounded-md">
                ...
                <div>
                    ...
                    <select name="id_kecamatan" id="id_kecamatan" class="w-full px-3 py-2 border border-gray-300 rounded-md">
        ...
        idProvinsi.addEventListener('change', function () {
            fetch(`/api/kabupaten/${this.value}`)
                ...
                .then(data => {
                    ...
                    data.forEach(item => {
                        idKabupaten.innerHTML += `<option value="${item.id_kabupaten}">${item.nama_kabupaten}</option>`;
                    });
        ...
        idKabupaten.addEventListener('change', function () {
            fetch(`/api/kecamatan/${this.value}`)
                ...
                .then(data => {
                    idKecamatan.innerHTML = '<option value="">-- Pilih Kecamatan --</option>';
                    data.forEach(item => {
                        idKecamatan.innerHTML += `<option value="${item.id_kecamatan}">${item.nama_kecamatan}</option>`;
                    });
                });
        });
    });
