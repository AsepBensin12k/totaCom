    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6">
            ...
            <div class="text-right mb-6">
                ...
                <p class="text-lg"><strong>Total Bayar : </strong> Rp{{ number_format($totalBayar, 0, ',', '.') }}</p>
            </div>
                    ...
                    <div class="flex-shrink-0">
                        <svg class="h-5 w-5 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <path fill-rule="evenodd"
                                d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zM9 9a1 1 0 100 2v3a1 1 0 001 1h1a1 1 0 100-2h-1V9z"
                                clip-rule="evenodd" />
                        </svg>
                    </div>
                    <div class="ml-3">
            ...
            <div class="text-right">
                <a href="{{ route('user.dashboard') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
