...
<div class="container mx-auto p-4">
    ...
    <a href="{{ route('pesanan.buat') }}" class="inline-block bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded mb-4">
    + Pilih Produk</a>
    ...
    @else
        ...
        <form action="{{ route('pesanan.hapusMultiple') }}" method="POST" id="formHapusMultiple">
            @csrf
            <button type="submit"
                class="bg-red-600 text-white px-4 py-2 rounded mb-4 hover:bg-red-700"
                ...
                <tbody>
                    ...
                    <tr class="bg-gray-100">
                        <td class="border border-gray-300 p-2 text-center">
                            <input type="checkbox" name="selected_produk[]" value="{{ $item['id_produk'] }}" class="selectItem" />
                        </td>
