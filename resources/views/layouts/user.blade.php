  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-16 items-center">
      <div class="flex-shrink-0 flex items-center">
        <a href="{{ route('user.dashboard') }}" class="text-2xl font-bold bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text">totaCom</a>
      </div>
      <div class="hidden sm:flex sm:space-x-8">
        <a href="{{ route('user.dashboard') }}" class="animated-link">Dashboard</a>
        <a href="{{ route('profile.index') }}" class="animated-link">Profile</a>
        ...
        <div class="relative group inline-block text-left">
          ...
          <div class="dropdown-menu absolute left-0 top-full w-44 bg-white border border-gray-200 rounded-lg shadow-lg hidden z-10">
            <a href="{{ route('pesanan.buat') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50">Buat Pesanan</a>
            <a href="{{ route('pesanan.riwayat') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50">Riwayat Pesanan</a>
          </div>
        </div>
      ...
      <div class="sm:hidden flex items-center">
        <button id="mobile-menu-button" class="p-2 text-gray-700 hover:text-blue-600 focus:outline-none flex items-center justify-center w-10 h-10">
    ...
    <div id="mobile-menu" class="hidden sm:hidden bg-white border-t border-gray-200 flex flex-col space-y-1 py-2 px-4 rounded-md shadow-md">
    <a href="{{ route('user.dashboard') }}" class="mobile-link">Dashboard</a>
    <a href="{{ route('profile.index') }}" class="mobile-link">Profile</a>
    <a href="{{ route('pesanan.keranjang') }}" class="mobile-link">Keranjang</a>
    <div class="border-t border-gray-200">
      <button onclick="togglePesanan()" class="w-full flex justify-between items-center px-4 py-3 text-gray-700 hover:bg-gray-100">
        Pesanan
